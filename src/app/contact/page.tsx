  ...
  return (
    <div className="flex flex-col items-center justify-center px-6">
      <h1 className="text-4xl md:text-5xl font-bold mb-6 text-center">
        Contact <span className="text-cyan-500">DaniBlog</span>
      </h1>
      ...
      <div className="w-full max-w-2xl flex flex-col-reverse gap-4">
        {/* Contact Information */}
        <div className="bg-orange-300 dark:bg-gray-800 p-6 rounded-lg shadow-lg text-center">
          <h2 className="text-2xl font-semibold mb-4">Get in Touch</h2>
          <p className="mb-4">Feel free to reach out to us directly:</p>
          <ul className="space-y-4">
            <li>
              <span className="font-bold">Email:</span> meerdaniyal544@gmail.com
            </li>
            <li>
              <span className="font-bold">Phone:</span> +92 347 788 7701
            </li>
            <li>
        ...
        {/* Contact Form */}
        <div className="bg-green-600 dark:bg-gray-800 p-6 rounded-lg shadow-lg">
